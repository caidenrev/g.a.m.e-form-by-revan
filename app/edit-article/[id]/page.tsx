...
export default function EditArticlePage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10 px-4 pt-24">
        <div className="w-full max-w-3xl mb-8 flex justify-between items-center bg-white/80 backdrop-blur p-4 rounded-3xl shadow-sm border border-blue-50">
