  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10 px-4">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex flex-col items-center pt-5 px-4 w-full">
        <div className="w-full max-w-2xl flex justify-between items-center bg-white/90 backdrop-blur-md px-6 py-3.5 rounded-full shadow-lg border border-white/20">
